...
func GetDisplayKeys() []string {
	return []string{"code", "name", "latest", "huanshou", "liangbi", "jingzhanzuo", "weipipei", "jingjiajine", "weipipeizhanbi", "zhulizengcang", "zhangfu", "weibi", "jiban", "shijian"}
}
